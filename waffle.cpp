...
// returns a vector of (x,y) points that are incorrect
vector<pair<int,int> > findIncorrect(char grid[5][5], char grid2[5][5]) {
    ...
    // print each incorrect found and the grids
...
// recursive call to find possible solution paths
void calculateMoves(char grid[5][5], char grid2[5][5], 
    ...
    for(unsigned int i=0; i<incorrects.size()-1; i++) {
        for(unsigned int j=1; j<incorrects.size(); j++) {
...
int main() {
    ...
    // TESTING
    char gridGiven[5][5] = {{'B','B','A','A','A'},
                            {'A',' ','A',' ','A'},
                            {'A','A','A','A','A'},
                            {'A',' ','A',' ','A'},
                            {'A','A','A','A','A'}};

    char gridSolved[5][5] = {{'A','A','A','A','A'},
                             {'A',' ','A',' ','A'},
                             {'A','A','A','A','A'},
                             {'A',' ','A',' ','A'},
                             {'B','B','A','A','A'}};
